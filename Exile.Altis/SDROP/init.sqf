...
//edit by http://www.exilemod.com/forums/users/captainjack/ for exile 
...
SDROP_MissionTimer = 15;			//mission timer - time taken for new helicopter to arrive / conditional (default: 900, which is 15 minutes real-time)
